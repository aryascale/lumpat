...
export default function CategorySection({
  ...
  return (
    <div className="category-wrap">
      <div className="editorial-card f1-top10">
        <div className="header-row border-b-2 border-red-600/30 pb-4 mb-4">
          <div>
            <h2 className="section-title">{categoryKey} — Top 10</h2>
            <div className="subtle">Top 10 per kategori (CSV)</div>
          </div>

          <div className="tools">
            <button className="editorial-btn-ghost" onClick={exportTop10}>
              Export Top 10 CSV
            </button>
