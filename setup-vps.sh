...
echo "============================================"
echo "  🖥️  Setting up VPS for Lumpat"
echo "============================================"
...
echo "✅ Database created: bcr_db"
echo "⚠️  CHANGE the password! Run: mysql -e \"ALTER USER 'bcr_user'@'localhost' IDENTIFIED BY 'YOUR_STRONG_PASSWORD';\""
